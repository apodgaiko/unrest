...
- [Role capability policy](capability-policy.md), packaged
  [policy](../../src/unrest_harness/bundled/policies/role-capabilities.v1.json),
  and [schema](../../schemas/role-capabilities.schema.json) — fail-closed
  provider, filesystem, process, environment, credential, and approval
  authority for every runtime role.
